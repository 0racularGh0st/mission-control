...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto grid min-h-screen w-full max-w-[1600px] grid-cols-1 gap-3 p-3 lg:grid-cols-[220px_minmax(0,1fr)_300px]">
        ...
        <div className="flex min-h-0 flex-col gap-3">
          <header className="glass-panel rounded-xl p-2">
